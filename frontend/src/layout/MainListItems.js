...
import { FcTodoList, FcComboChart, FcViewDetails, FcAssistant, FcFlashOn, FcTemplate, FcCalendar, FcContacts, FcBookmark, FcComments, FcSupport, FcList, FcBusinessContact, FcParallelTasks, FcFile, FcManager, FcMindMap, FcSettings, FcMoneyTransfer, FcDepartment} from "react-icons/fc";
        ...
        yes={() => (
          <>
            ...
            <ListSubheader
              ...
              inset
              color="inherit">
              <Typography variant="overline" style={{ fontWeight: 'normal' }}>  {i18n.t("Multiconexões")} </Typography>
            </ListSubheader>
